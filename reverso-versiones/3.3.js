...
function body2(where){
    ...
    setearBotones('btuno',botones1.getCell(1,1),IMm,()=>{},'tipo 1','Invertir mayúsculas y minúsculas');
    setearBotones('btdos',botones1.getCell(2,1),Mma,()=>{},'tipo 1','Mayúsculas y minúsculas aleatorias');
    setearBotones('bttres',botones4.getCell(1,1),sinEspacios,()=>{},'tipo 1','Sin espacios');
    setearBotones('btcuatro',botones4.getCell(2,1),desPal,()=>{},'tipo 1','Desbanear palabras');
    setearBotones('btcinco',botones2.getCell(2,1),espejo,()=>{},'tipo 2','No','top-center');
    setearBotones('btseis',botones3.getCell(2,1),girar,()=>{},'tipo 2','No','top-center');
