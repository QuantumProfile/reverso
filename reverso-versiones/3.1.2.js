...
insertarTexto(botones2.getCell(1,1),'Espejo horizontal?','bottom-center');
insertarTexto(botones3.getCell(1,1),'Girar 180°?','bottom-center');
...
setearBotones(botones2.getCell(2,1),espejo,()=>{},'tipo 2','No');
setearBotones(botones3.getCell(2,1),girar,()=>{},'tipo 2','No');
